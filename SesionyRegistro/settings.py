"""
Django settings for SesionyRegistro project.
...
SECRET_KEY = 'django-insecure-e!3_yovyi5%3d)b43r^d3x8yv5cud(^56fw^rq4e(5dzu%+9om'
...
ROOT_URLCONF = 'SesionyRegistro.urls'
...
WSGI_APPLICATION = 'SesionyRegistro.wsgi.application'
